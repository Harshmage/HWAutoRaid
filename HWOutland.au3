...
FindImage('Images\Outland-Entry.bmp', True, True, 5)
Sleep(1500)
FindImage('Images\Outland-TitleBanner.bmp', False, False)

$i = 0
Do
	FindImage('Images\Outland-ClaimReady.bmp', True, False)
	Sleep(500)
	FindImage('Images\Outland-OpenChests.bmp', True, False)
	FindImage('Images\08-Open.bmp', True, False)
	FindImage('Images\00-Close.bmp', True, False)
	$i = $i + 1
	if $i < 3 then FindImage('Images\Outland-Left.bmp', True, False)
Until $i = 3
Sleep(500)
FindImage('Images\00-Close.bmp', True, False)